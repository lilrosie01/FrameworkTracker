...
class FrameworksControllerTest < ActionController::TestCase
  ...
  test "should create framework" do
    assert_difference('Framework.count') do
      post :create, framework: { company: @framework.company, name: @framework.name, purpose: @framework.purpose, url: @framework.url, version: @framework.version }
    end
  ...
  test "should update framework" do
    patch :update, id: @framework, framework: { company: @framework.company, name: @framework.name, purpose: @framework.purpose, url: @framework.url, version: @framework.version }
    assert_redirected_to framework_path(assigns(:framework))
  end
