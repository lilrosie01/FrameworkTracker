...
class RailsControllerTest < ActionController::TestCase
  ...
  test "should create rail" do
    assert_difference('Rail.count') do
      post :create, rail: { company: @rail.company, framework: @rail.framework, generate: @rail.generate, name: @rail.name, url: @rail.url, version: @rail.version }
    end
  ...
  test "should update rail" do
    patch :update, id: @rail, rail: { company: @rail.company, framework: @rail.framework, generate: @rail.generate, name: @rail.name, url: @rail.url, version: @rail.version }
    assert_redirected_to rail_path(assigns(:rail))
  end
